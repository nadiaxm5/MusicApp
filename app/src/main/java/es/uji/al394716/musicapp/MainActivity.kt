...
class MainActivity : AppCompatActivity(), Interface1 {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        songButton.isEnabled = false        //Buttons are not visible if you do not select a word
    ...
    override fun showWords(words: Array<String>) {  //To show the words to use in the spinner
        ...
        object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                ...
                Log.d("Buttons are: ", artistButton.isEnabled.toString())
                presenter.setChosenWord(word)       //Call to pass the word selected
                Log.d("And now, buttons are: ", artistButton.isEnabled.toString())
            }
    ...
    override fun searchSong(){      //Song's button is pressed
        presenter.doSearchSong()
    }

    override fun searchArtist(){    //Artist's button is pressed
